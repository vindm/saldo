...
| `clients` | list | all ✅ from `README.md` (client_a, client_b, client_c) |
...
3. Diff against the previous snapshot; run through memory `typical-postings-bank-statements`, `contractor_debt_not_our_zone`, `silence_check_payment_first`.
